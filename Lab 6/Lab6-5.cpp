...
int main()
{
    ...
    cout << "PI, RATE, FindArea, FindCircumference, main, and radius are active here" << endl << endl;
{
    float area;
    cout << "Main function first inner block" << endl;
    cout << "PI, RATE, findArea, findCircumference, main, radius, and area are active here" << endl << endl;
...
}
{
    ...
    cout << "PI, RATE, FindArea, FindCircumference, main, radius, and circumference are active here" << endl << endl;
...
void findArea(float rad, float& answer)
{
    ...
    cout << "PI, RATE, findArea, findCircumferece, main, rad, and answer are active here" << endl << endl;
...
void findCircumference(float length, float& distance)
{
    ...
    cout << "PI, RATE, findArea, findCircumference, main, length, and distance are active here" << endl << endl;
