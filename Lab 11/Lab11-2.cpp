...
int main()
{
    ...
    cout << "Enter citizen 1's yearly income: " << endl;
    // Fill in code to read in this income tothe appropriate structure member
    cin >> citizen1.income;
    ...
    cout << "Enter citizen 2's yearly income: " << endl;
